...
const MEDIA_ASSETS = [
  ...
  './walkupsongs/Low Rider.mp3?v=57',
  ...
  './walkupsongs/Turn Down.mp3?v=57',
  './walkupsongs/Up.mp3',
  ...
  './walkupsongs/Work Out.mp3?v=57',
  './walkupsongs/Lace Em Up.mp3?v=57',
];
